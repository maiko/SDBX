...
// TestBackupHandlerListBackups verifies backup listing
func TestBackupHandlerListBackups(t *testing.T) {
	tmpDir := t.TempDir()
...
// TestBackupHandlerCreateBackup verifies backup creation
func TestBackupHandlerCreateBackup(t *testing.T) {
	tmpDir := t.TempDir()
